...
K_EXPORT_PLUGIN(KateFileBrowserFactory(KAboutData("katefilebrowserplugin","katefilebrowserplugin",ki18n("Filesystem Browser asd"), "0.1123", ki18n("Browse through the filesystem"), KAboutData::License_LGPL_V2)) )
...
QString KateFileBrowserPlugin::configPageName (uint number) const
{
  ...
  return i18n("Filesystem Browser Tab1");
}
...
{
  // init console
  QWidget *toolview = mainWindow->createToolView ("kate_private_plugin_katefileselectorplugin_modified", Kate::MainWindow::Left, SmallIcon("document-open"), i18n("Filesystem"));
